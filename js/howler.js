...
(function() {
  ...
  Howl.prototype = {
    ...
    init: function(o) {
      ...
      //self._duration = 0; // ARJAN
      self._duration = o.duration || 0; // ARJAN
      self._loaded = false;
      self._sounds = [];
      self._endTimers = {};
     ...
     */
    play: function(sprite, onend) { // ARJAN: Added onend
      var self = this;
      var args = arguments;
      var id = null;
      ...
      var ended = function() {
        ...
        var loop = !!(sound._loop || self._sprite[sprite][2]); // ARJAN
        ...
        if (!self._webAudio && loop) {
          self.stop(sound._id).play(sound._id); // ARJAN
        }
